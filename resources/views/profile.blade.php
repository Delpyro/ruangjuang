<x-app-layout>
    {{-- 
  File ini MENGGANTIKAN file profile.blade.php bawaan Breeze.
  File ini TIDAK menggunakan <x-app-layout> agar sesuai dengan
  layout kustom Anda (layouts.app) yang sudah memiliki Navigasi.
--}}
